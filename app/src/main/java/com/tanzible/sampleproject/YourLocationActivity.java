...
public class YourLocationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Leikai Khangminnashi");
    ...
    public void onClick(View view2) {
        ...
        switch (view2.getId()) {
            ...
            case R.id.registraion_layout /*2131297873*/:
                ...
                startActivity(new Intent(this.getApplicationContext(), Registration.class));
                finish();
                break;
